...
export default defineConfig({
  title: 'Salience',
  description: 'Know the state of your work without opening five tabs. A local-first view of branches, PRs, tickets, CI and agents.',
  base: '/salience-macos/',
  cleanUrls: true,
  appearance: 'dark',
  lastUpdated: false,
  head: [
    ...
    ['meta', { property: 'og:description', content: 'Know the state of your work without opening five tabs. A local-first view of branches, PRs, tickets, CI and agents.' }],
